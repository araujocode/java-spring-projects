...
import cyber.login.jwt.system.loginsystemjwt.user.dtos.AuthenticationDto;
...
public class AuthorizationService implements UserDetailsService {
    ...
    public ResponseEntity<Object> register(@RequestBody RegisterDto registerDto) {
        ...
        UserModel newUser = new UserModel(registerDto.getEmail(), encryptedPassword, registerDto.getRole().name());
